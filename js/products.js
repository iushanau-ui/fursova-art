...
const I18N = {
  en: {
    ...
    policy: {
      ...
      c1: "This site does not use tracking cookies. Visits are counted with GoatCounter — a privacy-friendly, cookie-free statistics tool that records only anonymous, aggregated data (page views, referrer, country, browser type) and never identifies or profiles individual visitors.",
  ...
  ru: {
    ...
    policy: {
      ...
      cookiesTitle: "Cookies",
      c1: "Сайт не использует отслеживающие cookies. Посещения подсчитываются сервисом GoatCounter — статистикой без cookies, которая сохраняет только обезличенные суммарные данные (просмотры страниц, источник перехода, страна, тип браузера) и не идентифицирует отдельных посетителей.",
  ...
  it: {
    ...
    policy: {
      ...
      cookiesTitle: "Cookies",
      c1: "Questo sito non utilizza cookie di tracciamento. Le visite vengono conteggiate con GoatCounter — uno strumento statistico rispettoso della privacy e senza cookie, che registra solo dati anonimi e aggregati (pagine viste, provenienza, paese, tipo di browser) e non identifica né profila i singoli visitatori.",
